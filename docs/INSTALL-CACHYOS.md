...
Confirm that KDE boots and the hardware works, then use Archway's minimal path:
...
log in once, and then run `just dms-config` to apply Archway's portable Niri/DMS
